# NyayaNest Content & Configuration Input Guide

This document outlines the exact fields and information required to complete the verified content and deployment configuration for NyayaNest.
...
* **Production Domain / Canonical URL**: e.g., `https://www.nyayanest.com` (or your exact production domain).
...
| `email` | String | Official contact email address | `"contact@nyayanest.com"` |
...
```javascript
{
  ...
  author: 'Author Name',               // String (e.g. "NyayaNest Legal Desk" or lawyer name)
